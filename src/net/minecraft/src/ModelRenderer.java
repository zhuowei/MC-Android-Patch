...
public class ModelRenderer
{
        ...
        if (!this.isHidden)
        {
            if (this.showModel)
            {
                ...
                if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F)
                {
                    ...
                    {
                        GLES11.glTranslatef(this.rotationPointX * par1, this.rotationPointY * par1, this.rotationPointZ * par1);
                        //GL11.glCallList(this.displayList);
                        this.renderDirect(par1);
                ...
                else
                {
                    ...
                    {
                        GLES11.glRotatef(this.rotateAngleZ * (180F / (float)Math.PI), 0.0F, 0.0F, 1.0F);
                    }

                    if (this.rotateAngleY != 0.0F)
                    {
                        GLES11.glRotatef(this.rotateAngleY * (180F / (float)Math.PI), 0.0F, 1.0F, 0.0F);
                    }

                    if (this.rotateAngleX != 0.0F)
                    {
                        GLES11.glRotatef(this.rotateAngleX * (180F / (float)Math.PI), 1.0F, 0.0F, 0.0F);
                    }
    ...
    /**
     * renders the model directly to the screen, without any buffering with display lists
     */
    private void renderDirect(float par1)
    {
        Tessellator var2 = Tessellator.instance;
